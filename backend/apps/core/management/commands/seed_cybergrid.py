...
class Command(BaseCommand):
    help = "Seeds initial database roles, administrator, student trainee, categories, scenarios, and competitions."
...
""",
        ...
        competition_obj, comp_created = Competition.objects.get_or_create(
            slug="cybergrid-national-championship-2026",
            defaults={
                "title": "CyberGrid National Championship 2026",
